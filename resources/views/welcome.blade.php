...
@section("content")
    <div class="container-fluid ">
        <div class="row con-fluid-padding-top">
            ...
            <div class="col-lg-7 col-md-6 col-12 pr-lg-2 pr-md-2 pr-auto pb-lg-0 pb-md-0 pb-2">
                <div class="view completed running-img"
                     style="background-image: url({{ asset('img/tegels/Competion.png')  }});
                    ...
                    <div class="mask d-flex justify-content-center align-items-center wow animated fadeIn delay-50ms">
                        ...
                        <div class="d-flex text-left w-100 h-100 flex-column p-4 ">
                            <div class="meter meter-round meter-big white nostripes">
                                <div class="text-right meter-finish text-white text-shadow-slight"
    ...
    <div class="container-fluid px-lg-5 px-md-4 px-auto">
        ...
        <div class="row px-lg-5 px-md-4 px-auto">
        ...
        <div class="row con-fluid-padding-top px-lg-5 px-md-4 px-auto display-lg">
